...
public class ArbitroMainActivity extends AppCompatActivity
        ...
        DesafiosArbitroFragment fragmentDesafios;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            ViewPager viewPager = (ViewPager) findViewById(R.id.viewPagerLayout_mainArbitro);
            ViewPagerAdapter adapter = new ViewPagerAdapter(getSupportFragmentManager());

            // Add Fragments to adapter one by one
            adapter.addFragment(new DesafiosArbitroFragment(), "Nuevos");
            adapter.addFragment(new DesafioArbitroAconfirmarFragment(), "A Confirmar");


            viewPager.setAdapter(adapter);

            tabLayout = (TabLayout) findViewById(R.id.tabLayout_mainArbitro);
            ...
            NavigationView navigationView = (NavigationView) findViewById(R.id.nav_view_arbitro);
        ...
        public boolean onNavigationItemSelected(MenuItem item) {
            ...
            if (id == R.id.desafios_arbitro) {
                ...
                startActivity(new Intent(ArbitroMainActivity.this, PartidosArbitroActivity.class));
