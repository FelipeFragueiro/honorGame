...
import com.appaloossa.honorgame.View.adapter.ArbitroAdapter.AdapterConfirmarDesafioArbitro;
 ...
 */
public class DesafioArbitroAconfirmarFragment extends Fragment {

    private String mAuth;
    private List<Desafio>desafiosList = new ArrayList<>();
    private RecyclerView recyclerView;
    private AdapterConfirmarDesafioArbitro adapter;
    private int contador;


    public DesafioArbitroAconfirmarFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_desafio_arbitro_aconfirmar, container, false);
        recyclerView = (RecyclerView)view.findViewById(R.id.recyclerView_desafioAConfirmar);
        cargarDesafiosSeleccionados();


        return view;
    }

    private void cargarDesafiosSeleccionados(){
        contador = 0;
        ...
        team.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adapter = new AdapterConfirmarDesafioArbitro(getContext());
